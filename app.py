...
from routes.external_weather import weather_bp
from routes.external_rates import rates_bp
...
app.register_blueprint(weather_bp, url_prefix="/external/weather")
app.register_blueprint(rates_bp, url_prefix="/external/rates")
